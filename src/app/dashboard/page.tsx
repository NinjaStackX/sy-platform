    ...
    <div className="space-y-8 dir-rtl">
      ...
      <div className="bg-gradient-to-l from-[#a2e2f3] to-[#71d3ec] rounded-2xl p-6 text-white flex items-center justify-between shadow-sm">
        ...
        <Link
          ...
          className="bg-white/90 hover:bg-white text-gray-700 px-4 py-2 rounded-xl text-xs font-bold flex items-center gap-2 shadow-sm transition"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <div className="bg-white rounded-2xl border border-gray-100 p-5 flex items-center justify-between shadow-sm">
          <div>
            <span className="text-2xl font-black text-gray-800 block">14</span>
            <span className="text-xs text-gray-400">الدورات المنجزة</span>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-5 flex items-center justify-between shadow-sm">
          <div>
            <span className="text-2xl font-black text-gray-800 block">3</span>
            <span className="text-xs text-gray-400">دورات جارية</span>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-5 flex items-center justify-between shadow-sm">
          <div>
            <span className="text-2xl font-black text-gray-800 block">387</span>
            <span className="text-xs text-gray-400">ساعات مكتملة</span>
          </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Link
            ...
            className="text-xs font-bold text-gray-400 hover:text-sky-500"
          >
            عرض الكل &lt;
          </Link>
        </div>
